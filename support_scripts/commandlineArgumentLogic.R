...
optionList = list(make_option(opt_str = c("-f", "--file"),
                  ...
                  make_option(opt_str = c("-a", "--affinity"),
                              ...
                              type = "double",
                              default = NULL,
                              help = "netMHCpan affinity cutoff (optional)"),
                  make_option(opt_str = c("-r", "--rank"),
                              action = "store",
                              type = "double",
                              default = NULL,
                              help = "netMHCpan percentile rank cutoff (optional, suggested is 2.8 ~500nM in A*02:01)"),
                  make_option(opt_str = c("-d", "--model"),
                              action = "store",
                              type = "double",
                              default = NULL,
                              help = "Random forest prediction model cutoff (optional, suggested cutoff 0.02 for PBMC, 0.01 for TIL screens)"),
